...
<div class="container py-2">
    ...
    ?>
        ...
        <label class="form-label">Remise <span id="discountValue"><?= $produit->discount ?>%</span></label>
        <input type="range" value="0" class="form-control" name="discount" min="0" max="90"
        value="<?= $produit->discount ?>" oninput="updateDiscountValue(this.value)">

        <script>
        function updateDiscountValue(val) {
        document.getElementById("discountValue").innerHTML = val + "%";
        }
        </script>
