            ...
            <div class="col-md-6">
                ...
                <div class="d-flex">
                    ...
                    if (!empty($discount)) {
                        ...
                        ?>
                        <h5 class="mx-1">
                            <span class="badge text-bg-danger"><strike> <?php echo $prix ?> <i class="fa fa-euro-sign"></i> </strike></span>
                        </h5>
                        <h5 class="mx-1">
                            <span class="badge text-bg-success"><?php echo $total ?> <i class="fa fa-euro-sign"></i></span>
                        </h5>
