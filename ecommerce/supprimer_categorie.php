<?php
    ...
    $sqlState= $pdo->prepare("DELETE FROM categorie where id=?"); // supprimer la ligne dans la base de donnes
    $supprime = $sqlState->execute([$id]);
    header ("location: categories.php"); // va vers la page categories.php
